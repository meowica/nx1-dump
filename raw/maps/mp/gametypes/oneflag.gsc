...
main()
{
	...
	level._flagReturnTime = getdvarint( "scr_oneflag_returntime" );
}
...
oneflag_ctf()
{
	...
	level._iconCapture3D = "waypoint_capture";
	level._iconCapture2D = "compass_waypoint_capture";
	level._iconDefend3D = "waypoint_defend";
	level._iconDefend2D = "compass_waypoint_defend";
	level._iconTarget3D = "waypoint_target";
	level._iconTarget2D = "compass_waypoint_target";
	
	precacheShader( level._icon2D["axis"] );
	precacheShader( level._icon2D["allies"] );

	precacheShader( level._iconCapture3D );
	precacheShader( level._iconDefend3D );

	precacheShader( level._iconCapture2D );
	precacheShader( level._iconDefend2D );

	precacheShader( level._iconTarget3D );
	precacheShader( level._iconTarget2D );

	precacheShader( "waypoint_kill" );
	
	level._teamFlags[game["defenders"]] = createTeamFlag( game["defenders"] );
	level._capZones[game["attackers"]] = createCapZone( game["attackers"] );
	level._flagCaptured = false;
}
...
createTeamFlag( team )
{
	...
	teamFlag maps\mp\gametypes\_gameobjects::set2DIcon( "friendly", level._iconDefend2D );
	teamFlag maps\mp\gametypes\_gameobjects::set3DIcon( "friendly", level._iconDefend3D );
	teamFlag maps\mp\gametypes\_gameobjects::set2DIcon( "enemy", level._iconCapture2D );
	teamFlag maps\mp\gametypes\_gameobjects::set3DIcon( "enemy", level._iconCapture3D );
...
createCapZone( team )
{
	entityTeam = level._otherTeam[game["original_defenders"]];
	...
	capZone maps\mp\gametypes\_gameobjects::set2DIcon( "friendly", level._iconTarget2D );
	capZone maps\mp\gametypes\_gameobjects::set3DIcon( "friendly", level._iconTarget3D );
...
onPickup( player )
{
	...
	else
	{
		...
		self maps\mp\gametypes\_gameobjects::set2DIcon( "friendly", level._iconTarget2D );
...
onDrop( player )
{
	...
	self maps\mp\gametypes\_gameobjects::set3DIcon( "friendly", level._iconDefend3D );
	self maps\mp\gametypes\_gameobjects::set2DIcon( "friendly", level._iconDefend2D );
	self maps\mp\gametypes\_gameobjects::set3DIcon( "enemy",    level._iconCapture3D );
	self maps\mp\gametypes\_gameobjects::setVisibleTeam( "any" );
...
onUse( player )
{
	...
	level._teamFlags[otherTeam] maps\mp\gametypes\_gameobjects::allowCarry( "none" );
	level._teamFlags[otherTeam] maps\mp\gametypes\_gameobjects::setVisibleTeam( "none" );
	level._teamFlags[otherTeam] maps\mp\gametypes\_gameobjects::disableObject();
	level._capZones[team] maps\mp\gametypes\_gameobjects::allowUse( "none" );
