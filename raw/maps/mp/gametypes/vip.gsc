...
extractionZone()
{
	...
	{	
		...
		level._extractionZone = extractionZone;
		
	trigger = level._extractionZone[0];
...
handleTimer( player )
{
	...
	level._extractionTime = 45;
	maps\mp\gametypes\_gamelogic::pauseTimer();
	level._timeLimitOverride = true;
	setGameEndTime( int( getTime() + (level._extractionTime * 1000) ) );
	wait level._extractionTime;
