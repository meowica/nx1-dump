...
init()
{
	level._killStreakFuncs["auto_shotgun"] = ::tryUseAutoShotgun;	
	level._killstreakSetupFuncs["auto_shotgun"] = ::shotgunSetup;

	level._killStreakFuncs["thumper"] = ::tryUseThumper;	
	level._killstreakSetupFuncs["thumper"] = ::thumperSetup;
